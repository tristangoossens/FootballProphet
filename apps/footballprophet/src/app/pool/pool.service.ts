...
export class PoolService {
    ...
    public GetPools(offset: number, limit: number): Observable<Pool[]> {
        ...
        return this.http.get(`${environment.api_url}/pools`, {
            headers: {
    ...
    public GetPoolById(id: string): Observable<Pool> {
        ...
        return this.http.get(`${environment.api_url}/pools/${id}`, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
        })
    ...
    public JoinPool(id: string): Observable<Pool> {
        return this.http.post(`${environment.api_url}/pools/${id}/join`, null, {
            headers: {
                'Authorization': `Bearer ${localStorage.getItem('token')}`
            }
        }).pipe(
